...
const Home = () => {
    return (
        <>
            <Helmet>
                <title>Home | Assiduity Engineering Ltd</title>
                <meta name="description" content="Professional architectural, mechanical, electrical, and plumbing design services. We turn your ideas into functional, safe, and modern structures." />
                <meta name="keywords" content="architectural design, MEP engineering, house wiring, construction design Uganda, Assiduity Engineering" />
                <meta name="author" content="Assiduity Engineering Ltd" />
