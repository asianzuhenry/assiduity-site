...
const Electrical = () => {
  return (
    <>
      <Helmet>
        <title>Electrical Design | Assiduity Engineering Ltd</title>
        <meta name="description" content="Efficient electrical systems including lighting, power distribution, and data networks designed for safety and compliance." />
        <meta name="keywords" content="electrical wiring, circuit design, power layout, low-voltage systems, building electricity" />
      </Helmet>
